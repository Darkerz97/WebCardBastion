    ...
    <div class="grid min-h-screen lg:grid-cols-[280px_1fr]">
        <aside class="border-r border-[color:var(--color-line)] bg-[linear-gradient(180deg,rgba(14,18,27,0.98),rgba(18,18,18,0.98))] px-6 py-8 text-stone-200">
            ...
            <nav class="mt-10 space-y-2 text-sm">
                ...
                <a class="block rounded-2xl border px-4 py-3 transition {{ request()->routeIs('cash-closures.*') ? 'border-[color:var(--color-brand-300)] bg-[color:var(--color-brand-500)] text-[color:var(--color-night)]' : 'border-transparent bg-white/5 text-stone-300 hover:border-[color:var(--color-line)] hover:bg-white/10 hover:text-white' }}" href="{{ route('cash-closures.index') }}">Cierres de caja</a>
                <a class="block rounded-2xl border px-4 py-3 transition {{ request()->routeIs('inventory-movements.*') ? 'border-[color:var(--color-brand-300)] bg-[color:var(--color-brand-500)] text-[color:var(--color-night)]' : 'border-transparent bg-white/5 text-stone-300 hover:border-[color:var(--color-line)] hover:bg-white/10 hover:text-white' }}" href="{{ route('inventory-movements.index') }}">Movimientos de inventario</a>
